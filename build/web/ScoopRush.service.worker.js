...
/** @type {string} */
const CACHE_VERSION = '1761867880|907383424';
/** @type {string} */
const CACHE_PREFIX = 'Scoop Rush-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ScoopRush.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ScoopRush.html","ScoopRush.js","ScoopRush.offline.html","ScoopRush.icon.png","ScoopRush.apple-touch-icon.png","ScoopRush.audio.worklet.js","ScoopRush.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ScoopRush.wasm","ScoopRush.pck","ScoopRush.side.wasm"];
